...
public class KeySignatureGraph extends ApplicationFrame {
	...
	private XYDataset createDataset(int one, int two) {
	...
	public static void main(String[] args) {
		// final KeySignatureGraph demo = new
		// KeySignatureGraph("Auditing Chart",new ArrayList<Users>(3));
		// demo.pack();
